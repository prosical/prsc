...
<body class="hold-transition skin-blue sidebar-mini layout-boxed">
						...
						<div class="box-footer">
							<div class="text-center">
								<ul class="pagination">
									...
									<!-- <li><a href="<c:url value='/board/list?page=${param.page-1}'/>">-</a></li> -->
	...
	$(document).ready(function() {
		...
		$("#count-per-page input[type=button]").on("click", function(){
			...
			let count = $(this).val();
			self.location = "list?page=${pageCreator.criteria.page}&keyword=${pageCreator.criteria.keyword}&condition=${pageCreator.criteria.condition}&countPerPage="+count;
		})
	});
