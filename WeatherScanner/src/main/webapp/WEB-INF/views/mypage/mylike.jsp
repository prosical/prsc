							...
							<div class="text-center">
								<ul class="pagination">
									...
									<c:if test="${pageCreator.prev}">
										<li><a
											href="<c:url value='/mypage/mylike${pageCreator.makeSearchURI(pageCreator.beginPage - 1)}' />">이전</a></li>
									</c:if>
									...
									<c:forEach var="idx" begin="${pageCreator.beginPage}"
										...
										<li
											...
											href="<c:url value='/mypage/mylike${pageCreator.makeSearchURI(idx)}'/>">${idx}</a></li>
									</c:forEach>

									<c:if test="${pageCreator.next}">
										<li><a
											href="<c:url value='/mypage/mylike${pageCreator.makeSearchURI(pageCreator.endPage + 1)}' />">다음</a></li>
									</c:if>
