							...
							<div class="box-body">
								...
								<div class="form-group Motitle">
									<label for="cityName">도시이름</label> <input class="form-control"
										...
										value="${article.cityName}">
								</div>
								<div class="form-group Motitle">
									<label for="title">도시별명</label> <input class="form-control"
								...
								<div class="form-group MoImg">
									<label for="cityImg">도시 이미지</label>
									<label class="form-control"></label><input class="form-control" 
									id="cityImg" name="cityImg" placeholder="사진 링크를 입력해주세요" value="${article.cityImg}">
								</div>
