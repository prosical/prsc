        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <ul class="footer-menu-item">
              ...
              <li class="scroll"><a href="#explore">리뷰관리</a></li>
              <li class="scroll"><a href="#reviews">추천 여행지 관리</a></li>
...
<%-- 
  ...
  <!--bootstrap.min.js-->
  <script src="<%=request.getContextPath()%>/resources/joo/assets/js/bootstrap.min.js"></script>
